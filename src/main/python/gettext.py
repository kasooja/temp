...
from optparse import \
    OptionParser  # for the tagging option; the module is deprecated, code should be updated, if time allows
...
parser.add_option('-t', '--tag', action='store', type='int', dest='tagger',
                  help='set this option to 1 to tag the text and extract only nouns, adjectives, and verbs')
